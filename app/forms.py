...
from django.contrib.auth.forms import AuthenticationForm, PasswordChangeForm, UserCreationForm, UsernameField, PasswordResetForm, SetPasswordForm
...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    new_password2 = forms.CharField(label=_("Confirm New Password"), strip=False, widget=forms.widgets.PasswordInput(attrs=
    {'autocomplete': 'new-password','class':'form-control'}))
